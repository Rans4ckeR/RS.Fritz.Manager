...
internal sealed class FritzWlanConfiguration2Service(Binding binding, EndpointAddress remoteAddress)
    : ClientBase<IFritzWlanConfiguration2Service>(binding, remoteAddress), IFritzWlanConfiguration2Service
{
