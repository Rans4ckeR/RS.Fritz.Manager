...
internal sealed class FritzWlanConfiguration3Service(Binding binding, EndpointAddress remoteAddress)
    : ClientBase<IFritzWlanConfiguration3Service>(binding, remoteAddress), IFritzWlanConfiguration3Service
{
